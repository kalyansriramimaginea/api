(function(){
    ...
    var messagePushController = function($location, messageResource, messageTypeResource, imageResource, $sce, $routeParams){
    ...
    app.controller('messagePushController', messagePushController);
